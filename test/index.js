...
describe ( 'Tiny Bin', it => {
  ...
  it ( 'can return the version', t => {
    ...
    const output = execSync ( './resources/demo_gitman.js --version --no-colors', { encoding: 'utf8' } ).trim ();
  ...
  it ( 'can return the bin help page', t => {
    ...
    const output = execSync ( './resources/demo_bump.js --help --no-colors', { encoding: 'utf8' } ).trim ();
  ...
  it ( 'can return the command help page', t => {
    ...
    const output = execSync ( './resources/demo_bump.js release --help --no-colors', { encoding: 'utf8' } ).trim ();
  ...
  it ( 'can execute a command', t => {
    ...
    const output1 = execSync ( './resources/demo_gitman.js user repo --no-colors', { encoding: 'utf8' } ).trim ();

    t.true ( output1.includes ( 'Default command executed' ) );

    const output2 = execSync ( './resources/demo_gitman.js clone user repo --no-colors', { encoding: 'utf8' } ).trim ();
