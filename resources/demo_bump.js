...
bin ( 'bump', 'Update a project\'s version number' )
  ...
  .option ( '--force2', 'Force the command without prompting the user', { section: 'General' } )
  .option ( '--no-scripts', 'Disable scripts', { section: 'Script' } )
  // .option ( '--silent <hey...>', 'Implicitly overridden --silent option', { section: 'General' } )
  .option ( '--silent <hey...>', 'Explicitly overridden --silent option', { section: 'General', override: true } )
  ...
  .option ( '--pretag <script>', 'Script to execute before taking the commit', { section: 'Script' } )
